...
function eq_add_customJS() {
	
    wp_register_script( 'customJS', get_template_directory_uri() . '/js/custom.js' , array( 'jquery' ), false, true );
...
function eq_add_jquery_scroll_to() {
    ...
    wp_register_script( 'scroll_to', get_template_directory_uri() . '/js/jquery.scrollTo.min.js', array( 'jquery' ), '2.1.1', true );
...
add_action( 'wp_enqueue_scripts', 'eq_add_customJS', 35 );
...
add_action( 'wp_enqueue_scripts', 'eq_add_jqueryUI', 55 );
add_action( 'wp_enqueue_scripts', 'eq_add_jquery_scroll_to', 60 );
add_action( 'wp_enqueue_scripts', 'eq_add_jquery_lavalamp', 65 );
